...
from joblib import load as pickle_loader
...
vectorizer = pickle_loader(os.path.join(curr_path, "data/vectorizer.pkl"))

print("Initializing model...")
model = pickle_loader(os.path.join(curr_path, "data/LRclf.pkl"))
